export default function quant(quant = 1) {
    return (
        `<div class="product__cart-quant">
            <button type="button" class="product__minus">
            ...
            <span class="product__quant"> ${quant} </span>
            <button type="button" class="product__plus">
